...
import { DEFAULT_OUTPUT_DIR, DEFAULT_CONCEPT_FILE, DEFAULT_GAME_DESIGN_FILE } from "../constants.js";
    ...
    async (params) => {
      try {
        ...
        for (const element of params.elements) {
          ...
          const prompt = styleHint ? `${basePrompt} Game style: ${styleHint}.` : basePrompt;
